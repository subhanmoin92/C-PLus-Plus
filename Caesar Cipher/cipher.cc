...
#include "cipher.h"              /* The header file consists of function prototypes, all libraries required and constants declaration*/
using namespace std;
...
if(infile1.fail()) error("Error : file 2 cannot be opened");  /*Error message is displayed*/
